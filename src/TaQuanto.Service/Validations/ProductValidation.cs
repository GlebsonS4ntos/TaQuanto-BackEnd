...
namespace TaQuanto.Service.Validations
{
    public class ProductValidation : AbstractValidator<CreateOrUpdateProductDto>
    {
        public ProductValidation()
        {
            ...
            RuleFor(p => p.Name)
                .NotEmpty().When(p => p.Name != null).WithMessage("O Produto deve possuir um Nome.")
            ...
            RuleFor(p => p.Description)
                .NotEmpty().When(p => p.Description != null).WithMessage("A Descrição não pode ser em branco.")
            ...
            RuleFor(p => p.EstablishmentId)
                .NotEmpty().When(e => e.EstablishmentId != null).WithMessage("O Produto deve pertencer a um Estabelecimento.");
            ...
            RuleFor(p => p.Price)
                .NotEmpty().When(p => p.Price != null).WithMessage("O Produto deve ter um Preco")
            ...
            RuleFor(p => p.CategoryId)
                .NotEmpty().When(p => p.CategoryId != null).WithMessage("O Produto deve ter uma Categoria");
        }
